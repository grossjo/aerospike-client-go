...
[![Aerospike Client Go](https://goreportcard.com/badge/github.com/grossjo/aerospike-client-go)](https://goreportcard.com/report/github.com/grossjo/aerospike-client-go)
...
[![Godoc](https://godoc.org/github.com/grossjo/aerospike-client-go?status.svg)](https://pkg.go.dev/github.com/grossjo/aerospike-client-go)
...
Up-to-date documentation is available in the [![Godoc](https://godoc.org/github.com/grossjo/aerospike-client-go?status.svg)](https://pkg.go.dev/github.com/grossjo/aerospike-client-go).
...
import (
  ...
  aero "github.com/grossjo/aerospike-client-go"
)
...
2. Get the client in your ```GOPATH``` : ```go get github.com/grossjo/aerospike-client-go```
  * To update the client library: ```go get -u github.com/grossjo/aerospike-client-go```
...
A simple API documentation is available in the [`docs`](docs/README.md) directory. The latest up-to-date docs can be found in [![Godoc](https://godoc.org/github.com/grossjo/aerospike-client-go?status.svg)](https://pkg.go.dev/github.com/grossjo/aerospike-client-go).
